...
return brojTelefona; } 
	...
	public void setBrojTelefona(String brojTelefona) { 
		if (brojTelefona.isBlank() || brojTelefona.isEmpty()) throw new IzuzetakTelefonskiRacun("Broj telefona ne sme biti null"); 
	...
	public void setVlasnik(String vlasnik) {
		if (vlasnik.isBlank() || vlasnik.isEmpty()) throw new IzuzetakTelefonskiRacun("Ime i prezime vlasnika telefona ne sme biti null"); this.vlasnik = vlasnik; } 
	//Redefinisana metoda 
