...
public void setNaslov(String naslov) throws IzuzetakCasopis { 
	if (naslov.isBlank() || naslov.isEmpty()) throw new IzuzetakCasopis("Naslov časopisa ne sme biti null"); 
	this.naslov = naslov; } 
...
public void setIzdavac(String izdavac) throws IzuzetakCasopis { 
	if (izdavac.isBlank() || izdavac.isEmpty()) throw new IzuzetakCasopis("Izdavač časopisa ne sme biti null"); 
...
public void setCena(double cena) throws IzuzetakCasopis { 
	if (cena <= 0) throw new IzuzetakCasopis("Cena mora biti veća od nule");
	this.cena = cena; } 
//Metoda za ispisivanje podataka o časopisu
public String toString(){ return "Naslov: " + naslov + "\nIzdavač: " + izdavac + "\nBroj časopisa: " + brojCasopisa + "\nCena: " + cena;
} }
