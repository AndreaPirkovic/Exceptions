 ...
 public class TestCasopis { 
	 public static void main(String[] args) throws Exception { 
		 ...
		 // Kreiranje objekata klase 		 Casopis 
		 ...
		 try {
			 ...
			 c.setCena(cena); // Štampanje podataka o časopisu 
			 System.out.println("\nUneti podaci o časopisu su: "); System.out.println(c.toString()); } catch (IzuzetakCasopis e) { System.out.println("Greška: " + e.getMessage()); } } 
		 }
