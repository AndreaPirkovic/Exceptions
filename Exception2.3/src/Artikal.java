 ...
 public class Artikal { 
	// Deklarisanje podataka 
	 ...
	 public void setNaziv(String naziv) throws IzuzetakArtikal { 
		 if (naziv == null) throw new IzuzetakArtikal("Naziv artikla ne sme biti null"); 
		 this.naziv = naziv; } 
...
if (proizvodjac == null) throw new IzuzetakArtikal("Proizvodjač artikla ne sme biti null");
this.proizvodjac = proizvodjac; } 
	 //Metoda za pristup podatku barkod 
	 public String getBarkod() { return barkod; } 
	 //Metoda za postavljanje podatka barkod
	 public void setBarkod(String barkod) throws IzuzetakArtikal { if (barkod == null) throw new IzuzetakArtikal("Barkod artikla ne sme biti null");
	 this.barkod = barkod; } 
	 ...
	 public void setCena(double cena) throws IzuzetakArtikal { 
		 if (cena <= 0) throw new IzuzetakArtikal("Cena mora biti veća od nule"); 
		 this.cena = cena; } 
