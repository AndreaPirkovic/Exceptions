...
public class Automobil { 
	...
	void unetiProizvodjacaAutomobila() throws IOException { 
		BufferedReader ulaz = new BufferedReader(new InputStreamReader(System.in));
		System.out.println("Unesite proizvodjača automobila: "); proizvodjac = ulaz.readLine(); } 
	...
	godiste = Integer.parseInt(ulaz.readLine()); 
		...
		catch (Exception e) { System.out.println("Niste dobro uneli broj");
	...
	void unetiPotrosnjuAutomobila() { 
		while (true) { 
			try { 
				...
				break; }
			catch (Exception e) { System.out.println("Niste ispravno uneli potrošnju automobila"); 
			} } } 
	// Redefinisana metoda 
