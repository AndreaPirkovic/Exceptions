...
public class Motor { 
	...
	public void setMarka(String marka) throws IzuzetakMotor { 
		if (marka.isBlank() || marka.isEmpty()) throw new IzuzetakMotor("Marka motora ne sme biti null"); 
		this.marka = marka; } 
	...
	public void setKubikaza(double kubikaza) throws IzuzetakMotor { 
		...
		else throw new IzuzetakMotor("Kubikaža mora biti veća od 50 i manja od 2000"); }
	//Metoda za ispisivanje podataka o motoru
	public void ispisi(){ System.out.println("Marka: " + marka + "\nKubikaža: " + kubikaza); 
	} }
