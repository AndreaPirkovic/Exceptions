 ...
 public class TestStudent { 
	 public static void main(String[] args) throws Exception { 
		 ...
		 try { 
			 ...
			 System.out.println("\nPodaci o studentu su: "); System.out.println("Ime i prezime: " + s.getImePrezime() + "\nBroj indeksa: " + s.getBrojIndeksa() + "\nProsecna ocena: " + s.getProsecnaOcena()); }
		 catch (Throwable e) { 
			 ...
			 e.printStackTrace(); // Kreiranje stack trace-a 
...
System.out.println("\nŠtampanje informacije o izuzetku iz stack trace-a"); for (int i = 0; i < stack.length; i++) System.out.println(stack[i]);
} } }
